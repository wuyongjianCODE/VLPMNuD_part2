...
#wuyongjian edit: to enable weight sharing,we modify 'yolo_pafpn.py' and 'yolox_base.py',make sure these .py file should be the same as the '-edit' backup-file! 
...
```
python tools/demo.py image -n yolox-l -c yolo/yolox_l.pth --path assets/dog.jpg --conf 0.25 --nms 0.45 --tsize 640 --save_result --device gpu
```
or
```shell
...
```shell
cd <YOLOX_HOME>
ln -s /data1/wyj/M/datasets/COCO ./datasets/COCO
```
